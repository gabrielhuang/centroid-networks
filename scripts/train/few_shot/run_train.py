...
#parser.add_argument('--regularizations', default='0.01,0.1,10,100,1', type=str, help='regularizations to try')
parser.add_argument('--regularizations', default='1', type=str, help='regularizations to try')
